...
10000 generations !                    { sets the number of generations to run the game for }
...
: make_phase_array
  make_array phase_array !
  array-x-size @ array-y-size @ * 0 do
    10 rnd 3 >= if
      1 phase_array @ i array_!
    else
      0 phase_array @ i array_!
    then
  loop
  ;
